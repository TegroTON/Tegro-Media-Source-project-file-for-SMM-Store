...
<link rel="apple-touch-icon" href="/assets/images/logo/apple-touch-icon-192x192.png">
...
<header class="header">
    <nav class="navbar navbar-expand-lg" id="scrollNavbar">
        <div class="container-fluid px-0">
            ...
            <a class="btn text-secondary d-none d-lg-block me-2" href="/balance.php"><i class="fas fa-wallet color-yellow me-2"></i>17860.8 ₽</a>
            <a class="btn btn-secondary d-none d-lg-block me-2" href="/dashboard.php">Мои заказы</a>
            <div class="dropdown">
                <button class="btn btn-secondary btn-icon" type="button" data-bs-toggle="dropdown" aria-expanded="false" aria-label="Меню">
                    <i class="fas fa-bars fs-20"></i>
                </button>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item" href="/balance.php">
                            <i class="nav-link__icon far fa-wallet me-3"></i>
                            Пополнить баланс
                        </a>
                    </li>
                    <li><a class="dropdown-item toggle-button" href="/dashboard.php"><i class="nav-link__icon far fa-list-ul"></i>Мои заказы</a></li>
                    <li><a class="dropdown-item toggle-button" href="/settings.php"><i class="nav-link__icon far fa-cog me-3"></i>Настройки</a></li>
                    <li>
